        ...
        <span style="color: #666; font-size: 11px;"><spring:message code="label.pfRegax"/></span>
           ...
           <tr>
            ...
            <tr>
                ...
                <td>
                	<input id="contractFromId" name="contractFrom" class="contractFromdatetimepicker" style="width: 100%;height: 20px; color: black;" type="text" size="30" maxlength="30" autocomplete="off">
