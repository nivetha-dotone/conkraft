...
<head>
<title>Inactive Contract Workmen Export</title>
...
<div class="page-header">
  <label for="principalEmployerId" style="color: darkcyan;">Principal Employer:</label> <select class="custom-select" id="principalEmployer" name="principalEmployerId" onchange="getContractorsAndTrades(this.value, '${sessionScope.loginuser.userAccount}')">
   ...
   <div class="page-header-buttons">
       <button type="button" id="exportBtn"  class="btn btn-default process-footer-button-cancel ng-binding" onclick="inactiveReportModuleCSV()">Export</button> 
         <button type="button" class="btn btn-default process-footer-button-cancel ng-binding" onclick=" loadCommonList('/reports/inactiveWorkmenList', 'Inactive Contract Workmen Report');">Cancel</button>
         </div>
