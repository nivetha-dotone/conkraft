...
<input type="hidden" id="loggedInUserAccount" value="${sessionScope.loginuser.userAccount}">
  <label for="principalEmployerId" style="color: darkcyan;">Principal Employer:</label>
   <select class="custom-select" id="principalEmployers" name="principalEmployerId" onchange="getContractorsForPoliceReports(this.value, document.getElementById('loggedInUserAccount').value)" style="color:gray;padding:3px;">
                          ...
                          <input type="hidden" id="autoSearchFunction" value="fetchPoliceReportData">
                            <input type="hidden" id="autoSearchParam" value="">
                            <select class="custom-select" id="contractors" name="contractors" onchange="fetchPoliceReportData()" style="color:gray;padding:3px;">
