                ...
                <table class="ControlLayout" cellspacing="0" cellpadding="0">
                    <tbody>
                        ...
                        <tr>
				            ...
				            <td style="display:none;"><input type=hidden id="proficiency" name="proficiency" style="width: 100%;height: 20px;" type="text" value="${GatePassObj.proficiency }" readonly></td>
                        </tr>
                        <tr>
...
<th><label class="custom-label"><span class="required-field">*</span><spring:message code="label.ifscCode"/></label></th>
	...
	<td><input style="width: 100%;height: 20px;" type="text"  name="pfCap"  id="pfCap" value="${GatePassObj.pfCap }" readonly/></td>
        ...
        <tr>
    			...
    			<c:if test="${ GatePassObj.gatePassAction ne '6'}">
                 <td>
                 <input id="reasonofOffboarding" name="reasonofOffboarding" style="width: 100%;height: 20px;" type="text" value="" readonly>
                   </td>
    			</c:if>							
			</tr>
			<c:if test="${not empty GatePassObj.attachmentOfReference && GatePassObj.gatePassAction eq '6'}">
            		<tr>
      				...
      				<%-- <c:if test="${not empty GatePassObj.FNFDocName && GatePassObj.gatePassAction eq '6'}">
            		<tr>
      				...
      				<c:if test="${not empty GatePassObj.feedbackFormDocName && GatePassObj.gatePassAction eq '6'}">
            		<tr>
      				...
      				<c:if test="${not empty GatePassObj.rateManagerDocName && GatePassObj.gatePassAction eq '6'}">
            		<tr>
      				...
      				<c:if test="${not empty GatePassObj.LOCDocName && GatePassObj.gatePassAction eq '6'}">
            		<tr>
