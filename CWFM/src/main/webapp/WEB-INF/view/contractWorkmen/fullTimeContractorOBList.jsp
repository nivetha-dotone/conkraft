...
<input type="hidden" id="autoSearchFunction" value="searchFullTimeContractorGatePassBasedOnPE">
<input type="hidden" id="autoSearchParam" value="fulltimecontractor">
        <button type="button" class="btn btn-default process-footer-button-cancel ng-binding"  onclick="searchFullTimeContractorGatePassBasedOnPE('fulltimecontractor')">Search</button>

  </div>
    <div>
    <c:if test="${UserPermission.addRights eq 1 }">
         <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="redirectToWorkmenFullTimeContractorAdd()">Add</button> 
     </c:if>
        <c:if test="${UserPermission.editRights eq 1 }">
         <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="redirectToWorkmenEdit('project')">Edit</button> 
     </c:if>
  
     <c:if test="${UserPermission.viewRights eq 1 }">
        <button type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="redirectToFullTimeContractorWorkmenView()">View</button>
...
<tr >
        ...
        <tbody>
            ...
            <tr>
           <td  ><input type="checkbox" name="selectedWOs" value="${wo.transactionId}" class="bulk-check"
