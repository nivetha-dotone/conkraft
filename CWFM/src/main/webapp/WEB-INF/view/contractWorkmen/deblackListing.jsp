...
<input type="hidden" id="autoSearchFunction" value="searchDeBlackList">
<input type="hidden" id="autoSearchParam" value="">
    ...
    <c:if test="${UserPermission.editRights eq 1 }">
     ...
     <button type="submit" onclick="deblackListBulkApprove(4)" class="btn btn-success process-footer-button-cancel ng-binding">
        Bulk Approve
    </button>
    <% } %>
    </div>
...
<tr>
    ...
    <a href="#"
       ...
       onclick="redirectToWorkmenDeblackViewLink('${wo.gatePassId}'); return false;">
        ${wo.transactionId}
    </a>
</td>
												 <td  > ${ wo.gatePassId } </td> 
