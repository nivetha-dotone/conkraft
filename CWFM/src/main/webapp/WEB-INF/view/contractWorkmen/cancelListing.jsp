...
<input type="hidden" id="autoSearchFunction" value="searchCancel">
<input type="hidden" id="autoSearchParam" value="">
   ...
   <div>
    ...
    <c:if test="${UserPermission.editRights eq 1 }">
     ...
     <button type="submit" onclick="cancelBulkApprove(4)" class="btn btn-success process-footer-button-cancel ng-binding">
        Bulk Approve
    </button>
    <% } %>
    </div>
...
<tr>
    ...
    <a href="#"
       ...
       onclick="redirectToWorkmenCancelViewLink('${wo.gatePassId}'); return false;">
        ${wo.transactionId}
    </a>
</td>
												 <td  > ${ wo.gatePassId } </td> 
