       ...
       <div class="tabs-container">
        <div class="tabs">
         ...
         <div class="action-buttons" >
            ...
            <button   type="submit" class="btn btn-default process-footer-button-cancel ng-binding" onclick="draftGatePass('${sessionScope.loginuser.userId}','quick')">Draft</button>
