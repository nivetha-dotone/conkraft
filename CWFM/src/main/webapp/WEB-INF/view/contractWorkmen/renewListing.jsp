...
<input type="hidden" id="autoSearchFunction" value="searchRenew">
<input type="hidden" id="autoSearchParam" value="">
    ...
    <% if (user != null && ( !"Contractor".equals(roleName) && !"Security".equals(roleName) )) { %>
     <button type="submit" onclick="renewBulkApprove(4)" class="btn btn-success process-footer-button-cancel ng-binding">
        Bulk Approve
    </button>
    <% } %>
    </div>
...
<tr >
    ...
    <a href="#"
       ...
       onclick="redirectToWorkmenRenewViewLink('${wo.gatePassId}'); return false;">
        ${wo.transactionId}
    </a>
</td>
												 <td  > ${ wo.gatePassId } </td> 
