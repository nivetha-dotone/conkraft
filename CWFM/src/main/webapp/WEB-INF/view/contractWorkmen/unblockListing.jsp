...
<input type="hidden" id="autoSearchFunction" value="searchUnBlockList">
<input type="hidden" id="autoSearchParam" value="">
   ...
   <div>
    ...
    <c:if test="${UserPermission.editRights eq 1 }">
     ...
     <button type="submit" onclick="unblockBulkApprove(4)" class="btn btn-success process-footer-button-cancel ng-binding">
        Bulk Approve
    </button>
    <% } %>
    </div>
...
<input type="hidden" id="roleId" value="${roleId}">
 <input type="hidden" id="approvercomments" value=""> 
  ...
  <thead>
    <tr>
      <th><input type="checkbox" id="selectAllBlockCheckbox" onchange="toggleAll(this)"></th>
  ...
  <c:if test="${GatePassListingDto.size()>0 }">
    ...
    <a href="#"
       ...
       onclick="redirectToWorkmenUnblockViewLink('${wo.gatePassId}'); return false;">
        ${wo.transactionId}
    </a>
</td>
												 <td  > ${ wo.gatePassId } </td> 
