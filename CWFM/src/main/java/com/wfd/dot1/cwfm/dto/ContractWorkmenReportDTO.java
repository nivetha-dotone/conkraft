...
public class ContractWorkmenReportDTO {
    ...
    private String mainContractorCode;
    ...
    public String getMainContractorCode() {
        return mainContractorCode;
    }
    public void setMainContractorCode(String mainContractorCode) {
        this.mainContractorCode = mainContractorCode;
    }
    ...
    public String getEicmanager() {
        return eicmanager;
    }
    public void setEicmanager(String eicmanager) {
        this.eicmanager = eicmanager;
    }
    ...
    public String getPvsDocType() {
        return pvsDocType;
    }
    public void setPvsDocType(String pvsDocType) {
        this.pvsDocType = pvsDocType;
    }
